...
<html lang="en">
    <head>
        ...
        <title>Berita Tanjungpinang</title>
        <link rel="icon" type="image/png" href="{{asset('assets/img/logo-tpi.png')}}" />
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#">Berita Tanjungpinang</a>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('/assets/img/gedung-gonggong.jpg')">
            <div class="container position-relative px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="site-heading">
                            <h1>Kabar Terkini</h1>
                            <span class="subheading">Tanjungpinang dan Sekitarnya</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <ul class="list-inline text-center">
                            <li class="list-inline-item">
                                <a href="https://www.linkedin.com/in/frhnn772" target="blank">
                            ...
                            <li class="list-inline-item">
                                <a href="https://instagram.com/farhan.mulyaputra" target="blank">
                                    <span class="fa-stack fa-lg">
                                        <i class="fas fa-circle fa-stack-2x"></i>
